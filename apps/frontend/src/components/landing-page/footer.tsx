    ...
    <footer className="mt-16 border-t-2 border-muted-2">
      <div className="container mx-auto max-w-7xl">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-10 border border-muted-foreground rounded-xl p-4 px-8">
            <p>Stay Connected</p>
        ...
        <div className="flex items-center justify-between py-6 border-t-2 border-muted-2">
